...
Давайте поможем бедолаге, иначе не сносить ему головы!`),
			...
			new Scene([new Answer("./img/scientist.png", "Учёный Феодосий. 50 лет. Курит."), 
				...
				new Evidence("#", "- Осколки колб и лужи химикатов<br/>- Обломки очков, найденные на месте взрыва<br/>- Странный запах горючего газа от плаща сторожа")),
			new Scene([new Answer("./img/scientist.png", "Учёный Феодосий. 50 лет. Курит."), 
				new Answer("./img/punk.png", "Физик-ядерщик Арсен. Любит пиротехнику и экстрим"), 
				...
				new Evidence("#", "- Обгоревшие ромашки, найденные в коридоре<br/>- Разбитые колбы<br/>- Разноцветные реактивы, перемешанные в хаотичном порядке")),
			new Scene([new Answer("./img/scientist.png", "Учёный Феодосий. 50 лет. Курит.", true), 
				new Answer("./img/punk.png", "Физик-ядерщик Арсен. Любит пиротехнику и экстрим"), 
				new Answer("./img/watchmans_daughter.png", "Дочка сторожа. Любит цветы."), 
				new Answer("./img/watchman.png", "Сторож лаборатории. Никого не подозревает. Близорукий.")], 
				new Evidence("#", "- Странный свёрток возле входа, похож на сигару<br/>- От некоторых вещей, вроде личного микроскопа профессора, не осталось даже обломков<br/>- Разлитые и разбросанные материалы")),],
